  ...
  return (
    <section className="relative py-24 md:py-32 lg:py-40 bg-navy-900 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 left-1/3 w-[300px] h-[300px] rounded-full bg-navy-600/20 blur-[80px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="mt-5 text-lg text-navy-300 max-w-xl mx-auto">
        ...
        <motion.p
          className="mt-6 text-xs text-navy-500"
          initial={{ opacity: 0 }}
